...
public class Scheduler extends Tools{
	...
	public int getNext(SimulationMS simulationms) {
		...
		//System.out.println( "No de step effectu� : " + simulationms.getExecutionOrderHistory().size());
		...
		if(simulationms.getSchedulerType().equals("with file")) {
			...
			// TODO renvoyer le bon int, throw les bonnes exeptions
			// simulationms.getExecutionOrderHistory().size() permet d'avoir le nombre de step qui a �t� effectu�.
